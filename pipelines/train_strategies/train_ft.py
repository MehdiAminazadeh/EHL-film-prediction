# file: pipelines/train_strategies/train_ft.py
...
def train_ft_transformer(
    *, cfg, df: pd.DataFrame, logger
    ...
    """
    FT-Transformer strategy:
      - HPO via Optuna on arrays
      - Build preprocessing + FT estimator pipeline (scaled+dense)
      - K-Fold CV with unified early stopping
    ...
    # allow lr alias used by adapter
    ...
    pipe = make_pipeline(
        ...
        target_col=target,
        preproc_cfg={
            "force_scale": True,   # your sample uses StandardScaler
            "ohe_sparse": False,   # dense features for tensor input
        },
